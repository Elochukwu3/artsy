  ...
  return (
    <div>
      <ul>
        ...
        {products.length > 0 && (
          <li className="flex my-10 justify-between max-md:flex-col-reverse  max-md:gap-10 ">
            ...
            <div
              className={
                !slideView ? "basis-[40%] h-auto text-left" : "basis-[100%]"
              }
            >
              <div
                className={
