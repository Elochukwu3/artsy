  ...
  return (
    <div className="flex justify-center my-10">
          <div className="grid grid-cols-3 space-x-10 text-xl capitalize">
            <button
              className={activeButton === "btn_1" ?"border-none bg-[#f2f2f2]" :"border-none bg-none"}
            ...
            <button 
             className={activeButton === "btn_2" ?"border-none bg-[#f2f2f2]" :"border-none bg-none"}
            id = "btn_2"
           onClick={shoppingHandler} >
              Shopping details
            </button>
            <button  
            className={activeButton === "btn_3" ?"border-none bg-[#f2f2f2]" :"border-none bg-none"}
            id = "btn_3">Payment details</button>
          </div>
        </div>
