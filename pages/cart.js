        ...
        <ul>
          {products.length > 0
            ? products.map((items) => {
                ...
                return (
                  <li key={id} className="flex justify-between border-y border-grey-500 py-5">
                    <div className="flex h-[200px]  gap-4">
                      ...
                      <ul className="block h-full py-4 space-y-5 text-[18px] capitalize">
                        ...
                        <li className="flex gap-4 font-semibold">
                          <span className="cursor-pointer" onClick={()=> decrementCount(id)}>-</span>
                          <span className="cursor-pointer">{count}</span>
                          <span className="cursor-pointer" onClick={()=> incrementCount(id)}>+</span>
                        </li>
                      </ul>
                    </div>
                    <div className="flex flex-col justify-between py-4 items-center">
                      <p className="rounded-full border border-grey-600 p-1 cursor-pointer" onClick={()=>removeItem(items)}>
                        <img src="../featured-img/close.png" className="scale-75"/>
                      </p>
                      <p>${count * price}.00</p>
                    </div>
                  </li>
